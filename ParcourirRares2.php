...
$query = "SELECT Nom_prod, `Type de vente`, Prix, Photo, Description FROM produits WHERE Catégorie = 'Rares'";
...
$stmt->execute($types);
$produits_rares = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<!-- Formulaire pour trier par type de vente -->
    <div class="sort-container">
        <form method="GET" action="ParcourirRares.php">
    ...
    <div class="container">
        <?php if (!empty($produits_rares)): ?>
            <?php foreach ($produits_rares as $produit): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Aucun article rare disponible pour le moment.</p>
        <?php endif; ?>
    </div>
