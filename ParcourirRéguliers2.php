...
$query = "SELECT Nom_prod, `Type de vente`, Prix, Photo, Description FROM produits WHERE Catégorie = 'Régulier'";
...
$stmt->execute($types);
$produits_réguliers = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    <div class="header">
        <div class="box-choix-left">
          <a href="Accueil2.php"><img src="accueil.webp" alt="Accueil"></a>
        </div>

        <div class="box-choix-right">
          <a href="Notifications.php"><img src="notification.webp" alt="Notifications"></a><br>
          <a href="Panier.php"><img src="panier.webp" alt="Panier"></a><br>
          <a href="VotreCompte2.php"><img src="compte.webp" alt="votre compte"></a>
        </div>
    ...
    <div class="sous-navigation">
        <a href="ToutParcourir2.php"><button>Tout les articles</button></a>
      <a href="ParcourirRéguliers2.php"><button>Articles réguliers</button></a>
      <a href="ParcourirHautDeGamme2.php"><button>Articles haut de gamme</button></a>
      <a href="ParcourirRares2.php"><button>Articles rares</button></a>
    </div>


<!-- Formulaire pour trier par type de vente -->
    <div class="sort-container">
        <form method="GET" action="ParcourirRéguliers.php">
    ...
    <div class="container">
        <?php if (!empty($produits_réguliers)): ?>
            <?php foreach ($produits_réguliers as $produit): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Aucun article régulier disponible pour le moment.</p>
        <?php endif; ?>
    </div>
