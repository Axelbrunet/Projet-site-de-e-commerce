...
$query = "SELECT Nom_prod, `Type de vente`, Prix, Photo, Description FROM produits";

if (!empty($types)) {
    $placeholders = implode(',', array_fill(0, count($types), '?'));
    $query .= " WHERE `Type de vente` IN ($placeholders)";
}
...
<body>
	...
	<div class="sort-container">
	    <form method="GET" action="ToutParcourir2.php">
